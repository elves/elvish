...
-   Symbolic links are now always treated as ordinary files during wildcard
    expansions.

    As a side effect, this change fixes a bug where broken symbolic links can
    terminate a wildcard expansion prematurely ([#1240](https://b.elv.sh/1240)).
