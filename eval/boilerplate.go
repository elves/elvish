...
func (cp *compiler) chunkOp(n *parse.Chunk) effectOp {
	cp.compiling(n)
	return effectOp{cp.chunk(n), n.Begin(), n.End()}
}
...
func (cp *compiler) pipelineOp(n *parse.Pipeline) effectOp {
	cp.compiling(n)
	return effectOp{cp.pipeline(n), n.Begin(), n.End()}
}
...
func (cp *compiler) formOp(n *parse.Form) effectOp {
	cp.compiling(n)
	return effectOp{cp.form(n), n.Begin(), n.End()}
}
...
func (cp *compiler) assignmentOp(n *parse.Assignment) effectOp {
	cp.compiling(n)
	return effectOp{cp.assignment(n), n.Begin(), n.End()}
}
...
func (cp *compiler) redirOp(n *parse.Redir) effectOp {
	cp.compiling(n)
	return effectOp{cp.redir(n), n.Begin(), n.End()}
}
