...
// ```
//
// Output help text for the function or variable matching `$search-term` if there is a single search
// term. If no search terms are provided the documentation for the `builtin:help` command is output.
//
...
// there is one search term and `$true` if there is more than one search term. The search is
...
// term is searched in the documentation independent of the preceding term. The terms do not have to
// be adjacent in the documentation; however, the documentation must contain all search terms.
//
