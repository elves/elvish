...
// MatchingRegexp can be passed to Case.Puts and Case.Prints to match any string that matches the
// regexp pattern. If the pattern is not a valid regexp, the test will panic.
type MatchingRegexp struct{ Pattern string }

// NonMatchingRegexp can be passed to Case.Puts and Case.Prints to match any string that does not
