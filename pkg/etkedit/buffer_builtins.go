...
var bufferBuiltinsData = map[string]func(*comps.TextBuffer){
...
func makeMove(m pureMover) func(*comps.TextBuffer) {
	return func(buf *comps.TextBuffer) {
		buf.Dot = m(buf.Content, buf.Dot)
	}
}

func makeKill(m pureMover) func(*comps.TextBuffer) {
	return func(buf *comps.TextBuffer) {
...
func makeTransform(t pureTransformer) func(*comps.TextBuffer) {
	return func(buf *comps.TextBuffer) {
